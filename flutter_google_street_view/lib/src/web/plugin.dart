...
class FlutterGoogleStreetViewPlugin {
  ...
  /// The Flutter widget that will contain the rendered Street View. Used for caching.
  Widget get htmlWidget {
    if (_widget == null) {
      // For modern Flutter web, we return the div directly
      // This approach works without platform view registry
  ...
  FlutterGoogleStreetViewPlugin(Map<String, dynamic> arg) {
    ...
    // Register the view factory using the modern Flutter web approach
